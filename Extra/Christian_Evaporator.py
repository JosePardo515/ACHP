...
#import numpy as np
from ACHP.FinCorrelations import WavyLouveredFins,FinInputs,IsFinsClass
...
class EvaporatorClass():
    ...
    def Calculate(self):
        ...
        self.Fins.Air.RH_out=HAProps('R','T',self.Tout_a,'P',101325,'W',self.omega_out)  #neglect pressure drop across evaporator
        self.DP_r=self.DP_r_superheat+self.DP_r_2phase
