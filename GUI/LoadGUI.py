...
def LoadGUI(self):
    ...
    def MenuBar(self):
        ...
        self.Help.Append(self.HelpHelp)
    ...
    def CycleInputs(self):
        ...
        self.cmbRefrigerant.Append(listREFPROP)
    ...
    def PumpIHXInputs(self):
        ...
        self.lblPumpp.SetToolTip("Pressure of the secondary loop.  Not currently used since properties are only a function of temperature.")
        ...
        self.lblPumpmdot.SetToolTip("Mass flow rate of secondary fluid")
        ...
        self.lblPumpEfficiency.SetToolTip("Combined efficiency of motor and pump set")
        ...
        self.lblIHXLength.SetToolTip("Length of the internal heat exchanger")
        self.lblIHXAnnOD.SetToolTip("Outer diameter of the wetted portion of the annulus")
        self.lblIHXAnnID.SetToolTip("Inner diameter of the wetted portion of the annulus")
        self.lblIHXTubeID.SetToolTip("Inner diameter of the tube at the center of the IHX")
    ...
    def CoolingCoilInputs(self):
        ...
        self.lblCoolingCoilFinType.SetToolTip("The type of fins employed")
        self.cmbCoolingCoilFinType.SetSelection(0)
        self.lblCoolingCoilFinFPI.SetToolTip("Number of fins per inch")
        self.lblCoolingCoilFinpd.SetToolTip("Twice the amplitude of the wave of the fin")
        self.lblCoolingCoilFinxf.SetToolTip("Half the wavelength of the wave of the fin")
        self.lblCoolingCoilFint.SetToolTip("Thickness of the fin")
        self.lblCoolingCoilFink.SetToolTip("Fin Conductivity")
        self.cmbCoolingCoilFink.SetSelection(0)
        self.lblCoolingCoilTubesNtubes.SetMinSize((120, -1))
        self.lblCoolingCoilTubesNtubes.SetToolTip("Number of tubes per bank (AKA row) of the heat exchanger.  See circuiting figure for clarification")
        self.lblCoolingCoilTubesNbank.SetToolTip("Number of banks (AKA rows) of tubes in the heat exchanger (see coil circuiting diagram for clarification)")
        self.lblCoolingCoilTubesL.SetToolTip("Length of one tube.  If looking face-on at the coil installed in duct with the tubes horizontally, the width of the duct")
        self.lblCoolingCoilTubesOD.SetToolTip("Outer diameter of the tubes")
        self.lblCoolingCoilTubesID.SetToolTip("Inner diameter of the tubes")
        self.lblCoolingCoilTubesPl.SetToolTip("Longitudinal pitch of the tubes.  Also called horizontal pitch.  If you look edge-on at the coil with flow of air from left to right, the horizontal spacing between banks")
        self.lblCoolingCoilTubesPt.SetToolTip("Transverse pitch of tubes.  Also called vertical pitch.  Vertical spacing of tubes if looked at end-on with flow from left to right")
        self.lblCoolingCoilTubesNcircuit.SetToolTip("Number of circuits that the flow is distributed betwen for the working fluid.  See circuiting diagram for clarity")
        ...
        self.txtCoolingCoilAirp = wx.TextCtrl(self.CoolingCoilInputsPanel, -1, "101325")
        ...
        self.lblCoolingCoilAirVdot.SetToolTip("Volumetric flow of humid air into the coil in cubic meters of air per second.")
        self.lblCoolingCoilAirTdb.SetToolTip("Dry bulb temperature")
        self.lblCoolingCoilAirp.SetToolTip("Ambient pressure (absolute)")
        self.lblCoolingCoilAirRH.SetToolTip("Relative humidity of the air from 0 to 1  (0% to 100% RH)")
        self.lblCoolingCoilPower.SetToolTip("Fan power of the blower")
    ...
    def CondenserInputs(self):
        ...
        self.lblCondenserFinType.SetToolTip("The type of fins employed")
        self.cmbCondenserFinType.SetSelection(0)
        self.cmbCondenserFink.SetSelection(0)
        self.lblCondenserFinFPI.SetToolTip("Number of fins per inch")
        self.lblCondenserFinpd.SetToolTip("Twice the amplitude of the wave of the fin")
        self.lblCondenserFinxf.SetToolTip("Half the wavelength of the wave of the fin")
        self.lblCondenserFint.SetToolTip("Thickness of the fin")
        self.lblCondenserFink.SetToolTip("Fin Conductivity")
        ...
        self.lblCondenserTubesNtubes.SetToolTip("Number of tubes per bank (AKA row) of the heat exchanger.  See circuiting figure for clarification")
        self.lblCondenserTubesNbank.SetToolTip("Number of banks (AKA rows) of tubes in the heat exchanger (see coil circuiting diagram for clarification)")
        self.lblCondenserTubesL.SetToolTip("Length of one tube.  If looking face-on at the coil installed in duct with the tubes horizontally, the width of the duct")
        self.lblCondenserTubesOD.SetToolTip("Outer diameter of the tubes")
        self.lblCondenserTubesID.SetToolTip("Inner diameter of the tubes")
        self.lblCondenserTubesPl.SetToolTip("Longitudinal pitch of the tubes.  Also called horizontal pitch.  If you look edge-on at the coil with flow of air from left to right, the horizontal spacing between banks")
        self.lblCondenserTubesPt.SetToolTip("Transverse pitch of tubes.  Also called vertical pitch.  Vertical spacing of tubes if looked at end-on with flow from left to right")
        self.lblCondenserTubesNcircuit.SetToolTip("Number of circuits that the flow is distributed betwen for the working fluid.  See circuiting diagram for clarity") 
        ...
        self.txtCondenserAirp = wx.TextCtrl(self.CondenserInputsPanel, -1, "101325")
        ...
        self.lblCondenserAirVdot.SetToolTip("Volumetric flow of humid air into the coil in cubic meters of air per second.")
        self.lblCondenserAirTdb.SetToolTip("Dry bulb temperature")
        self.lblCondenserAirp.SetToolTip("Ambient pressure (absolute)")
        self.lblCondenserAirRH.SetToolTip("Relative humidity of the air from 0 to 1  (0% to 100% RH)")
        self.lblCondenserPower.SetToolTip("Fan power of the blower")
    ...
    def EvaporatorInputs(self):
        ...
        self.lblEvaporatorFinType.SetToolTip("The type of fins employed")
        self.cmbEvaporatorFinType.SetSelection(0)
        self.lblEvaporatorFinFPI.SetToolTip("Number of fins per inch")
        self.lblEvaporatorFinpd.SetToolTip("Twice the amplitude of the wave of the fin")
        self.lblEvaporatorFinxf.SetToolTip("Half the wavelength of the wave of the fin")
        self.lblEvaporatorFint.SetToolTip("Thickness of the fin")
        self.lblEvaporatorFink.SetMinSize((120, -1))
        self.lblEvaporatorFink.SetToolTip("Fin Conductivity")
        ...
        self.lblEvaporatorTubesNtubes.SetToolTip("Number of tubes per bank (AKA row) of the heat exchanger.  See circuiting figure for clarification")
        self.lblEvaporatorTubesNbank.SetToolTip("Number of banks (AKA rows) of tubes in the heat exchanger (see coil circuiting diagram for clarification)")
        self.lblEvaporatorTubesL.SetToolTip("Length of one tube.  If looking face-on at the coil installed in duct with the tubes horizontally, the width of the duct")
        self.lblEvaporatorTubesOD.SetToolTip("Outer diameter of the tubes")
        self.lblEvaporatorTubesID.SetToolTip("Inner diameter of the tubes")
        self.lblEvaporatorTubesPl.SetToolTip("Longitudinal pitch of the tubes.  Also called horizontal pitch.  If you look edge-on at the coil with flow of air from left to right, the horizontal spacing between banks")
        self.lblEvaporatorTubesPt.SetMinSize((120, -1))
        self.lblEvaporatorTubesPt.SetToolTip("Transverse pitch of tubes.  Also called vertical pitch.  Vertical spacing of tubes if looked at end-on with flow from left to right")
        self.lblEvaporatorTubesNcircuit.SetToolTip("Number of circuits that the flow is distributed betwen for the working fluid.  See circuiting diagram for clarity")
        ...
        self.txtEvaporatorAirp = wx.TextCtrl(self.EvaporatorInputsPanel, -1, "101325")
        ...
        self.lblEvaporatorAirVdot.SetToolTip("Volumetric flow rate of air through indoor heat exchanger")
        self.txtEvaporatorAirVdot.SetToolTip("Volumetric flow of humid air into the coil in cubic meters of air per second.")
        self.lblEvaporatorAirTdb.SetToolTip("Dry bulb temperature")
        self.lblEvaporatorAirp.SetToolTip("Ambient pressure (absolute)")
        self.lblEvaporatorAirRH.SetToolTip("Relative humidity of the air from 0 to 1  (0% to 100% RH)")
        self.lblEvaporatorPower.SetToolTip("Fan power of the blower")
    ...
    def CompressorInputs(self):
        ...
        self.lblCompfp.SetToolTip("Fraction of the electrical power input which is lost to the ambient")
        self.lblCompVdot_ratio.SetToolTip("Scale factor to the compressor displacement")
        ...
        self.cmdLoadCoeffs.SetToolTip("Load ARI coefficients from file")
        self.cmdARIInfo.SetToolTip("More information about the ARI correlation")
        self.txtCompCoeffsFile.SetToolTip("Currently loaded file")
    ...
    def LineSetInputs(self):
        ...
        self.lblLineSetL.SetToolTip("Length of the tube from the condensing unit to the coil installed indoors in the duct work.  ")
        self.lblLineSetOD_supply.SetToolTip("Outer diameter of the liquid line for DX systems, supply line for secondary systems")
        self.lblLineSetID_supply.SetToolTip("Inner diameter of the suction line for DX systems, return line for secondary systems")
        self.lblLineSetOD_return.SetToolTip("Outer diameter of the suction line for DX systems, return line for secondary systems")
        self.lblLineSetID_return.SetToolTip("Inner diameter of the suction line for DX systems, return line for secondary systems")
        self.lblLineSetTubek.SetToolTip("Tube Conductivity")
        self.lblLineSetInsult.SetToolTip("Thickness of the insulation")
        self.lblLineSetInsulk.SetToolTip("Thermal conductivity of the insulation")
        self.cmbLineSetInsulk.SetSelection(0)
        self.lblLineSeth_air.SetToolTip("Combined heat transfer coefficient for radiation and convection")
        self.lblLineSetT_air.SetToolTip("Effective temperature of the environment that the line set interacts with thermally")
